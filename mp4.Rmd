...
*Tags:* movies, sequel, remake, reboot, history, hollywood
...
You’ve heard it said: no movies are original anymore. It certainly feels that way. [Just this year](http://uproxx.com/movies/2017-sequels/) we have Cars 3, The Mummy, a new Guardians of the Galaxy movie, a Beauty and the Beast remake, a new Fast and the Furious, the ninth Planet of the Apes movie, and the latest installment in the Star Wars franchise. However, in reality, far fewer of these movies are released than may appear. 

In a December 2016 [Tylt poll](https://thetylt.com/entertainment/are-there-too-many-hollywood-reboots-and-sequels), the vast majority (79.3%) of respondents said that they believe there are “#TooManyReboots.” [^1] We set out to determine if this was actually true, or if the number of unoriginal movies is being blown out of proportion. As it turns out, we are not even at peak sequel or remake production in history, and when considering the fact that more movies are being made now than ever before, unoriginal films make up significantly smaller proportion of the movie industry than they have in the past.

In order to determine the number of unoriginal movies produced since 1895, we pulled data on all movies in the IMDb[^2] tagged with the keywords “`remake`,” “`reboot`,” or “`sequel`.” These tags represent unoriginal movies of several different types:
...
These might seem like pretty big numbers when you consider how many movies you watch per year. Who has time to go see all 77 sequels? You’d have to go to the movies 1 ½ times per week to achieve that! 

When you look at the history of sequels, remakes, and reboots over time, the only movie type currently at its peak is reboots, with five films in 2017. Remakes and sequels both reached their peak production long ago: in 1941 and 1994, respectively. We have fewer sequels and remakes being made than before, and if we take into consideration the fact that the movie industry has grown over time, expanding to the point where around 60,000 movies are produced each year, these unoriginal films make up a smaller percentage of the movie industry than they ever have.
...
As seen above, the highest percentage of unoriginal movies occurred in the 1940s. However, even in the biggest year for unoriginality, 1942, sequels, remakes, and reboots made up less than 5% of all the movies released. Over the last few decades, the percentage of unoriginal movies has been in considerable decline.This year, only a fraction of 1% of all movies made were unoriginal. 

An obvious reason for this is the large and increasing number of movies made. In 1942, just over 2,000 movies were produced whereas this year, over 50,000 movies were created. Sequel, remake and reboot production just can’t seem keep up with the ever growing number of movies.

So if there really aren’t that many unoriginal movies being made, why does it seem like they’re everywhere?

Even though we may seem crazy for claiming that there aren’t enough original movies after seeing all this data, there is certainly a reason that sequels, remakes, and reboots fill our thoughts so much. That reason is **money**. Of the top 20 [highest grossing movies](http://www.boxofficemojo.com/alltime/world/) of all time, only 4 can be classified as truly original: “Avatar,” “Titanic,” “Frozen,” and “Minions.” [^3]
...
We like things we are familiar with, something known as the [Mere Exposure Effect](https://www.psychologytoday.com/blog/sapient-nature/201201/familiarity-breeds-enjoyment). Naturally it applies to movies: being familiar with a movie’s premise or it’s characters makes us more likely to go see it. Additionally, unoriginal movies require a lot less work on the part of the viewer if they are familiar with the original. As many people use movies as a way to relax, having less work figuring out plot and characters looks very appealing. 
...
If moviegoers continue to purchase tickets to unoriginal movies, companies will continue to produce them at a fast rate, because there’s little risk involved. Producers have an idea of how big their audience will be, there’s already a lot of time put into character development, and there’s already a dedicated fan base that can be counted on to go watch the movie when it’s released. Who wouldn’t release a movie guaranteed to be a success?

It seems like moviegoers are causing their own frustration. The only way to reduce the number of these movies made and reduce the level of annoyance is to stop watching them. If you’re someone who votes “#TooManyReboots,” it might be time to consider watching some indie movies instead. You’re not likely to get anywhere by streaming into the theaters every time a new Star Wars movie gets announced.

==========================================================================================================

*This project's iterations can be found in our GitHub repository.*[^5]


[^1]: Conducted at the end of 2016, the poll is not a random sample. It was voluntary and only accessible by users who accessed the Tylt website. However, it does still provide a glimpse as to what moviegoers think of reboots, since it can be assumed that most respondents were film fans. 
...
[^5]: [Github repository](https://github.com/ambertin/mp4.git)
