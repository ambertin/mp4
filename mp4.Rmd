...
In order to determine the number of unoriginal movies produced, we pulled data on all feature length movies released in the past century tagged with the keywords `remake`, `reboot`, or `sequel` in the IMDb. 
